CC = g++
CUCC = nvcc -m64 -ccbin $(CC) -lineinfo
TARGET = testtu
...
$(TARGET): test.o tensorUtil.o errorHandle.o sdt_alloc.o
	$(CC) -Wall -g test.o tensorUtil.o errorHandle.o sdt_alloc.o -o $(TARGET) $(INCPATHS) $(LIBPATHS) $(COMMON_LIBS)
test.o: test.c tensorUtil.h errorHandle.h sdt_alloc.h
	$(CC) -g -c test.c $(INCPATHS) $(LIBPATHS) $(COMMON_LIBS)
...
errorHandle.o: errorHandle.cu errorHandle.h
	$(CUCC) -g -c errorHandle.cu $(INCPATHS) $(LIBPATHS) $(COMMON_LIBS)
sdt_alloc.o: sdt_alloc.c sdt_alloc.h
	$(CC) -g -c sdt_alloc.c $(INCPATHS) $(LIBPATHS) $(COMMON_LIBS)
clean:
	rm -f *.o
